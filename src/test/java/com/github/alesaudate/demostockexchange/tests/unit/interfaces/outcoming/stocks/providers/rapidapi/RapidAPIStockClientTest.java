...
import static com.github.alesaudate.demostockexchange.utils.FileUtils.getResponseDataForRapidAPI;
...
public class RapidAPIStockClientTest {
    ...
    public void testRetrievalOfAPIData() {
        ...
        var rapidAPIStocksClient = new RapidAPIStockClient(randomNYSEStock(),
                randomRapidAPIKey(),
                mockWebClientBuilder(getResponseDataForRapidAPI("sample-01.json")),
                randomInternetHost());
